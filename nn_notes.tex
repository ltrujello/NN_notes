...
\begin{document} 
  ...
  \section{Backpropagation: More generally}
    ...
    $t$ varies over the hidden nodes in layer $n$.
    Also, observe that in this description the nodes in the 
    $N$-th layer (i.e. $h_k^N$) correspond to the output of our neural network.
