...
\end{tikzpicture}
  ...
  \begin{center}
    ...
    \draw[->, ] (3.1920553198993438, 4.83995390008388) to (5.807944680100656, 2.66004609991612);
    \draw[->, ] (3.230769230769231, 3.6538461538461537) to (5.769230769230769, 2.5961538461538463);
    \draw[->, ] (3.25, 2.5) to (5.75, 2.5);
    \draw[->, ] (3.230769230769231, 1.3461538461538463) to (5.769230769230769, 2.4038461538461537);
    \draw[->, color=Orange, thick] (3.1920553198993438, 0.16004609991611995) to (5.807944680100656, 2.33995390008388);
\end{tikzpicture}
...
\end{tikzpicture}
  ...
  \begin{center}
    ...
    \node[above] at (0.7152331919396064, 1.903972340050328) { 4 };
    \node[above] at (0.7152331919396064, 0.5960276599496719) { 2 };
...
\end{tikzpicture}
  ...
  \section{Backpropagation: More generally}
    ...
    \node at (0.3, 0.75) { $h_j^{(n-1)}$ };
    \node at (4.3, 1.75) { $h_i^{(n-1)}$ };
    \node at (2.0, 1.0) { $w_{ij}^{(n)}$ };
    \node at (0, 1.5) { \vdots };
    \node at (0, -0.75) { \vdots };
    \node at (4, 2.5) { \vdots };
    \node at (4, 0.25) { \vdots };
